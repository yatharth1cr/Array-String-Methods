...
); //The last character of If you are still thinking the answer is no! is !
...
console.log(message.slice(-5)); //s no!
...
console.log(newMessage.replace('stil', '')); //If you can't l thinking the answer is no!
...
console.log(newMessage.replace('thinking', 'decide')); //If you can't still decide the answer is no!

// Log all the characters from the message variable (you can user for..of loop on string)
for (let strings of message) {
  console.log(strings);
}
